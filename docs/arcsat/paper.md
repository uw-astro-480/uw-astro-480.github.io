...
- The paper must not be longer than 4 pages. You can use double column if necessary and a font size not smaller than 10pt. You can write the paper with any software you like (Word, LaTeX, etc.) but please make sure that the final product is a PDF. You must include figures and tables as needed in your paper.
